...
PINCODES = ["110012", "689713", "400001", "500082", "400026", "302017"]
...
def auth_cmd(message):
    ...
    try:
        t = int(p[1])
        if t not in ADMIN_ID: return bot.reply_to(message, "❌ Access Denied: This ID is not on the hardcoded license list.")
